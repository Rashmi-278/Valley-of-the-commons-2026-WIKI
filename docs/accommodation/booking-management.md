...
Application submitted
        |
Application reviewed (Vero + team)
        |
Accepted - Acceptance email sent
        |
Acceptance flow materials:
  - Payment link (30% deposit)
  - Room and Roomate preference form
  - Group chat invite
  - Virtual meeting schedule
  - Volunteer role interest form
        |
Deposit received - Room tentatively assigned
        |
Full payment deadline (end of month / pre-June 1 for early bird)
        |
Room confirmed - Added to occupancy tracker
        |
1 month out: Welcome packet sent
        |
...
```
Application submitted (lighter form)
        |
Accepted - Payment link for chosen week(s)
        |
Full payment upfront
        |
Room confirmed - Added to occupancy tracker
        |
Welcome packet sent 2 weeks before their week
        |
...
| Term                | Detail                                                                      |
| ------------------- | --------------------------------------------------------------------------- |
| **Deposit**         | 30% of total, due upon acceptance                                           |
